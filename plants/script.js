...
allButtons.forEach(button => {
    button.addEventListener('click', function(event) {
        alert('с этим заданием я не справился (всего наполовину), но очень хотел бы разобраться. Если есть желание помочь, наведи в комментариях на верный путь пожалуйста, буду ооочень благодарен!) Знаю, что скорее через массивы надо делать, но никак не могу сообразить')
